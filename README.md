...
- getBSseqIndex_DMLtest_EE.R : adapted functions from the DSS R package (DOI: 10.18129/B9.bioc.DSS)
  - Adapted getBSseqIndex function to include more than 2 experimental conditions in the CpG filtering steps of the DMLtest function
  - Adapted DMLtest function to include more than 2 experimental conditions in the CpG filtering steps
